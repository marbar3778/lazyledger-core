...
func (app *localClient) PreprocessTxsAsync(
	ctx context.Context,
...
func (app *localClient) FinalizeBlockSync(ctx context.Context, req types.RequestFinalizeBlock) (*types.ResponseFinalizeBlock, error) {
	app.mtx.Lock()
	defer app.mtx.Unlock()
